...
public class GameControl {
    ...
    public static InventoryItem[] getSortedInventoryList() {
        ...
        InventoryItem[] orginalInventoryList = SuperAdventure.getCurrentGame().getInventory();

        // clone or make a copy of the original list
        InventoryItem[] inventoryList = orginalInventoryList.clone();
